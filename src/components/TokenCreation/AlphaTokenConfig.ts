...
export const REWARD_MINT_GLTCH_MAINET = new anchor.web3.PublicKey('GLtch7krBYgjyNFT7qdLevdnimLzGQFcJsHYgprD1PuP');
// export const ALPHA_OWNER_ATA = new anchor.web3.PublicKey('7HL9xo4rA48cR6CYsxZ4dzJa3zt3FZgGGUaB26JRWwrS');
export const SALT_ADDRESS = new anchor.web3.PublicKey('SALThRKa8JFD3XoGbLshzg61kaBHFFCeggDH8ydNEaE')
