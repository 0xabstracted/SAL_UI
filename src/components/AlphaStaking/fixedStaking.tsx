...
const FixedStaking = () => {
    ...
    const completeStakeFn =async () => {
        console.log('complete stake here');
    }
    ...
    const claimRewardsFn =async () => {
        console.log('claim rewards here');
    }
    ...
    return (
        <div id="main-mobile" className={logoLoading ? "main-bg-raffles black-bg" : "main-bg-raffles"}>
            {logoLoading && (
              ...
              <div className="fixed-staking-main-bg">
                <div className="pull-left full-width">
                  <div className="stake-logo-parent">
                    {!isMobile && <a href="/"><img src={LogoWhite} className="stake-logo pointer" alt="" /></a>}
                    {!isMobile && <a href="/"><img src={CloseAlpha} className="stake-close-logo" alt="" /></a>}
                    ...
                    <div className="user-menu-parent">
                      <ul>
                        <li>Claimed Tokens : {stakedBal} <img src={Refresh} onClick={refreshRewardsFn} className="refresh-farmer-icon" alt="" /></li>
                        <li className="pointer" onClick={claimRewardsFn}>Claim Tokens</li>
                      </ul>
                    </div>
                    }
                  </div>
                  ...
                  <div className="staking-process-parent">
                    <div className="unstaked-nfts-div">
                      ...
                      <div className="stake-button-div"> 
                        <button className="nft-select-button" onClick={completeStakeFn}>Stake Now</button>
                      </div>}
                      </div>
                    </div>
                    <div className="staked-nfts-div">
                      <div className="staking-nft-display">
                        ...
                        {unstakedNft && 
                        <div className="stake-button-div"> 
                          <button className="nft-select-button" onClick={completeUnstakeFn}>Unstake Now</button>
                        </div>}
                      </div>
                    </div>
                  </div>
